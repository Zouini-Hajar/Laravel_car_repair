            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($suppliers as $item)
                        <tr data-modal-target={{ 'edit-modal-' . $item->id }} data-modal-show={{ 'edit-modal-' . $item->id }}
                        ...
                        <x-delete-modal :id="$item->id" route="/suppliers" />
                        <x-edit-supplier-modal :supplier="$item" />
                    @endforeach
                </tbody>
            </table>
